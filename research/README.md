...
- [Minecraft-native tectonic terrain](minecraft-native-tectonic-terrain.md): current v8 block-height contract with size 1=256/Y63, 2,048-block default plate spacing, derivative-damped detail, linear height transfer, exact integral sizes 1–4 and finite-column limits.
...
- [Tectonic viewer contracts](../docs/Tectonic-Viewer.md): separate Java 21 page/API with 49 top-bar fields, 21 parameters, coupled climate/ground/dendritic maps, native scale/readouts, block contours, bounded tiles, exact hydraulic/lake inspection and seven versioned subsystems.
...
- [Drainage-guided dendritic terrain fork](dendritic-terrain.md): a continuous four-scale erosion-morphology field guided by canonical receivers, with real rivers/lakes composed afterward and explicit reasons not to flood decorative filter errors.
