...
- [Tectonic viewer contracts](../docs/Tectonic-Viewer.md): separate Java21 page/API with27 top-bar fields,18 world parameters plus display-only contours, exact configuration/inspection, navigation/export, v1/v2-link migration and integration checks. Browser visual QA remains outstanding.
