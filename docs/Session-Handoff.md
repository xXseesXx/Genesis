...
Next: R2 explicit root/terminal candidate contracts and balanced ownership, then R3 end-to-end watershed comparison. Do not confuse exact finite accounting with completed infinite-world roots, arbitrary watershed integration or physical terrain realization. The preferred bounded root-region architecture is still a proposal, not a selected world partition. Full R4-R8 geology/climate/surface acceptance precedes Minecraft R9.
