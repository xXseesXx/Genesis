...
- DET: all 27 fields in the legacy model over a 64×64-chunk region in raster, shuffled cached, and cold per-chunk order; additional extreme seeds/coordinates. The continental composition gate separately checks all fields with cold crops/common-point zoom and relief cache/concurrency tests.
